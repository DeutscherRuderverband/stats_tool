      ...
      <v-col>
        ...
        <v-row>
          <v-col :style="{ minWidth: '220px', maxWidth: '400px' }">
            ...
            <a class="mr-6"><img src="@/assets/images/rp_negative.png" :style="{width: '100%'}"></a>
          </v-col>
          <v-col :style="{ minWidth: '220px', maxWidth: '400px'}">
            <h4>Reverse J-Shape</h4>
            <!-- <p>t1 &lt; t4, t4 &lt min(t2, t3)</p> -->
            <p>v1 > v4, v4 > max(v2, v3)</p>
            <a class="mr-6"><img src="@/assets/images/rp_rj.png" :style="{width: '100%'}"></a>
          </v-col>
          <v-col :style="{ minWidth: '220px', maxWidth: '400px' }">
            <h4>J-Shape</h4>
            <!--<p>t4 &lt; t1, t1 &lt; min(t2, t3)</p> -->
            <p>v4 > v1, v1 > max(v2, v3)</p>
            <a class="mr-6"><img src="@/assets/images/rp_j.png" :style="{width: '100%'}"></a>
          </v-col>
          <v-col :style="{ minWidth: '220px', maxWidth: '400px' }">
            <h4>Even</h4>
            <!--<p>0,99 &lt; [t1, t2, t3, t4] &lt; 1,01</p> -->
            <p>0,99 &lt; [v1, v2, v3, v4] &lt; 1,01</p>
            <a class="mr-6"><img src="@/assets/images/rp_even.png" :style="{width: '100%'}"></a>
          </v-col>
          <v-col :style="{ minWidth: '220px', maxWidth: '400px' }">
            <h4>Positiv</h4>
